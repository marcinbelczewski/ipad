...
- (void)scrollViewDidEndDecelerating:(UIScrollView *)scrollView {
    //NSLog(@"endDeclaring = %d", pageControl.currentPage);
    pageControlUsed = NO;
    //[self snapToPosition:scrollView];
}

- (void)scrollViewWillBeginDecelerating:(UIScrollView *)scrollView {
    //NSLog(@"beginDeclaring = %d", pageControl.currentPage);
     pageControlUsed = NO;
    [self snapToPosition:scrollView];
}
...
- (void)snapToPosition:(UIScrollView *)_scrollView {
    ...
    CGFloat newPosition = pageControl.currentPage * [self calculateItemWidth] - overlapWidth;
